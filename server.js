 ...
 * *  
 * *  Name: _____Daryan Chan_________ Student ID: __113973192____ Date: ___4/8/2020____ 
 * *
...
const app = express();
const dataServiceAuth = require("./data-service-auth");  //assignment 6 require
const clientSessions = require("client-sessions");  //assignment 6 require
...
// client sessions for assignment 6 part 4
...
//checks of a user is logged in. If not, will redirect user to /login route
...
//route for login page (assignment 6 step 5)
app.get("/login", function(req, res) {
    res.render('login');
});

//route for registration page (assignment 6 step 5)
